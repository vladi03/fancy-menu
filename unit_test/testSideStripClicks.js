...
describe('<SideStrip /> Clicks', () => {
    ...
    it('component loads', () => {
        ...
        assert.ok(homeButtonStartClass.indexOf("menuButtonActive")> 50, "button active");
        assert.strictEqual(settingsButtonStartClass.indexOf("menuButton"), 20, "button  not active");

        assert.ok(settingsButtonAfterClass.indexOf("menuButtonActive") > 50, "button active after click");
